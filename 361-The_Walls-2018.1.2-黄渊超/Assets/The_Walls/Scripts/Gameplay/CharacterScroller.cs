...
public class CharacterScroller : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < CharacterManager.Instance.characters.Length; i++)
        {
            ...
            Debug.Log("charData.characterSequenceNumber===" + charData.characterSequenceNumber);
    ...
    public void SelectBtn()
    {
        ...
        Debug.Log("characterSequenceNumber===" + currentCharacter.GetComponent<CharacterInfo>().characterSequenceNumber);
        BackBtn();
    }
